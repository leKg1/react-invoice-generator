...
const Header = props => {
  ...
  return (
    <Flex
      ...
      color={["white", "purple", "primary.700", "primary.700"]}
      {...props}
    >
      <Flex align="center">
        <Logo
          w="100px"
          color={["white", "purple", "primary.500", "primary.500"]}
        />
      </Flex>
      ...
      >
        ...
        >
          ...
          <MenuItems to="/contracts" isLast>
            <Button
              size="md"
              rounded="md"
              color={["primary.500", "white", "white", "white"]}
              bg={["white", "purple", "primary.500", "primary.500"]}
              // _hover={{
              //   bg: [
              //     "primary.100",
              //     "primary.100",
